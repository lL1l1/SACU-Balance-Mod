...
Description['ual0301-cd'] = "Creates a weak Quantum Stasis Field around the SACU. Unlike the ACU's, it only partially reduces the fire rate and mobility of enemy units, although multiple weak fields can stack effectively.\n\nMinor Chrono Dampener = 35 radius, 10 second reload\nChrono debuff (T1-T3 and SACU) = 0.95x move speed and 0.92x fire rate, 5 second duration"
